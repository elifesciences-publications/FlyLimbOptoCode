...
% Plotting utility for plotting with error patches

% Default data plot width
dataWidth = 1;
...
if size(x,1) < 20 % Previously <50
    g=errorbar(x,y,y-el(end:-1:1,:),eu-y,'marker','o','LineWidth',dataWidth,'MarkerSize',8);
else
    g=plot(x,y,'LineWidth',dataWidth);
end
